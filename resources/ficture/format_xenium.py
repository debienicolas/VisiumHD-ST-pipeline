...
def format_xenium(input=None,output=None,feature='',min_phred_score=13,dummy_genes=''):

    parser = argparse.ArgumentParser()
    parser.add_argument('--input', type=str, help='Input transcript file from Xenium output, likely named transcripts.csv.gz',default=None)
    parser.add_argument('--output', type=str, help='Output file (tsv)',default=None)
    ...
    if args.input is None:
        ...
        args.min_phred_score = min_phred_score
        args.dummy_genes = dummy_genes
